...
namespace Tau19
{
    public partial class FestivalHightlightsForm : Form
    {
        public FestivalHightlightsForm()
        {
            InitializeComponent();
        ...
        private void g2pb_Click(object sender, EventArgs e)
        {
            Common.OpenVideo($"{System.Reflection.MethodBase.GetCurrentMethod().Name.Replace("pb_Click", "")}.mp4");
        }

        private void g3pb_Click(object sender, EventArgs e)
        {
            Common.OpenVideo($"{System.Reflection.MethodBase.GetCurrentMethod().Name.Replace("pb_Click", "")}.mp4");
        }
    }
